...
<section class="text-gray-600 dark:bg-slate-800 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-4/5 mx-auto flex flex-wrap">
            <img alt="sorry we could'nt load image" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://cdn.vox-cdn.com/thumbor/lM6S1jVTBrNEUQ0eEjf7eJBltnQ=/1400x1400/filters:format(jpeg)/cdn.vox-cdn.com/uploads/chorus_asset/file/22553557/VALORANT_YR1_KeyArt_4k_3_.jpg">
            
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h1 class="text-gray-900 dark:text-gray-200 text-3xl title-font font-medium mb-1">VLC 2023 South Asia</h1>
              ...
              <p class="dark:text-teal-100 leading-relaxed">
                The Valorant Challengers League 2023 South Asia is all set to take place from 18th March to 22nd April.
              </p>
              <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#E7362B"><path d="M0 0h24v24H0z" fill="none"></path><path d="M6 14l3 3v5h6v-5l3-3V9H6v5zm2-3h8v2.17l-3 3V20h-2v-3.83l-3-3V11zm3-9h2v3h-2zM3.502 5.874L4.916 4.46l2.122 2.12-1.414 1.415zm13.458.708l2.123-2.12 1.413 1.416-2.123 2.12z"></path></svg>
              <p class="dark:text-teal-100 leading-relaxed">
                It will feature a total prize pool of over INR 1.15 Crore and ten teams from the region shall be participating.
              </p>
              <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#E7362B"><path d="M0 0h24v24H0z" fill="none"></path><path d="M6 14l3 3v5h6v-5l3-3V9H6v5zm2-3h8v2.17l-3 3V20h-2v-3.83l-3-3V11zm3-9h2v3h-2zM3.502 5.874L4.916 4.46l2.122 2.12-1.414 1.415zm13.458.708l2.123-2.12 1.413 1.416-2.123 2.12z"></path></svg>
              <p class="dark:text-teal-100 leading-relaxed">
            ...
            <a href="http://localhost/demo%20site/valorant%20teams.php"  target="_blank">
        ...
        <footer class="text-gray-400 bg-gray-900 body-font">
            <div class="container px-8 py-8 mx-auto flex items-center sm:flex-row flex-col">
              ...
              <p class="text-sm text-gray-400 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4">© copyrights reserved eS-NewZZ 2022
                <a href="https://twitter.com/knyttneve" class="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">esnewzzofficial@gmail.com</a>
              </p>
