    ...
    <div class="lg:w-4/6 mx-auto">
      <div class="rounded-lg h-64 overflow-hidden">
        ...
        <div class="w-5/6 md:w-1/2 lg:w-full lg:max-w-lg">
            <img class="rounded object-cover object-center" src="https://c4.wallpaperflare.com/wallpaper/511/263/674/grand-theft-auto-vi-gta-vi-gta-6-rockstar-wallpaper-preview.jpg" alt="img" />
          </div>
        </center>  
      </div>
      <div class="flex flex-col sm:flex-row mt-10">
        <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
          ...
          <div class="profile-picture">
            <img src ="https://hips.hearstapps.com/hmg-prod/images/chris-evans-gettyimages-1138769185.jpg">
          </div>
        </center>
          <div class="flex flex-col items-center text-center justify-center">
            <h2 class="font-medium title-font mt-4 text-white text-lg">Chris Evans</h2>
        ...
        <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-800 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
          <p class="leading-relaxed font-serif text-lg mb-4">
            GTA 6 is one of the most anticipated video games of all time. Naturally, many players eagerly look up leaks and other rumors about the title. Here is a quick rundown of what is known about the next Grand Theft Auto game:
There was a massive collection of videos leaked on September 18, 2022The vast majority of known gameplay features come from the above leaksThere are a few other rumors regarding the game, particularly when it comes to its release date
          </p>
          ...
          <a href="http://localhost/demo%20site/">
            <center>
            <button class="inline-flex rounded border-0 bg-indigo-500 py-2 px-6 text-lg text-white hover:bg-indigo-600 focus:outline-none">Home</button>
            </center>
          </a>
        </div>
      </div>
