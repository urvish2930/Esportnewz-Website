    ...
    <div class="lg:w-4/6 mx-auto">
      <div class="rounded-lg h-64 overflow-hidden">
        ...
        <div class="w-5/6 md:w-1/2 lg:w-full lg:max-w-lg">
            <img class="rounded object-cover object-center" src="https://resources.esportsinsider.com/esportsinsider/2023/02/EVO-Header-1.png" alt="img" />
          </div>
        </center>  
      </div>
      <div class="flex flex-col sm:flex-row mt-10">
        <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
          ...
          <div class="profile-picture">
            <img src ="https://pbs.twimg.com/profile_images/762782102693613568/n5QWDNsg_400x400.jpg">
          </div>
        </center>
          <div class="flex flex-col items-center text-center justify-center">
            <h2 class="font-medium title-font mt-4 text-white text-lg">Jensen Ackles</h2>
