    ...
    <div class="lg:w-4/6 mx-auto">
      <div class="rounded-lg h-64 overflow-hidden">
        ...
        <div class="w-5/6 md:w-1/2 lg:w-full lg:max-w-lg">
            <img class="rounded object-cover object-center" src="https://www.callofduty.com/content/dam/atvi/callofduty/cod-touchui/blog/hero/mwii/MWII-002-REVEAL-TOUT.jpg" alt="img" />
          </div>
        </center>  
      </div>
      <div class="flex flex-col sm:flex-row mt-10">
        <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
          ...
          <div class="profile-picture">
            <img src ="https://www.pinkvilla.com/imageresize/chris_future_thor.jpg?width=752&t=pvorg">
          </div>
        </center>
          <div class="flex flex-col items-center text-center justify-center">
            <h2 class="font-medium title-font mt-4 text-white text-lg">Chris hamesworth</h2>
        ...
        <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-800 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
          <p class="leading-relaxed font-serif text-lg mb-4">The patch notes for Call of Duty: Modern Warfare 2 and Warzone 2 Season 2 were just released on the game's official website. Season 2 introduced a massive amount of playable content as well as some well-balanced adjustments.
